...
final class TextEn implements TextCatalog {
    public String text(int id) {
        switch (id) {
            ...
            case TextId.HISTORY_MESSAGES: return "Recent messages to include (2-24)";
            ...
            case TextId.IMAGE_TOO_LARGE: return "Image exceeds 96 KB; compress it first";
            case TextId.IMAGE_DIMENSIONS_UNKNOWN: return "Image dimensions could not be verified; loading was stopped to protect memory";
            case TextId.IMAGE_PIXELS_TOO_LARGE: return "Image exceeds 65,536 pixels; resize it to about 256×256";
            ...
            case TextId.IMAGE_PIXELS_PREVIEW_SKIPPED: return "Image exceeds 65,536 pixels; preview skipped";
            ...
            case TextId.RETURNED_IMAGE_TOO_LARGE: return "Returned image exceeds 256 KB";
